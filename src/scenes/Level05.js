...
class Level05 extends Phaser.Scene {
    ...
    create() {
        ...
        this.MAP_WIDTH = (34 * 256) / 4;
        this.MAP_HEIGHT = (20 * 256) / 4;
        ...
        this.add.image(-1000,-1800,"sky").setOrigin(0, 0).setScale(0.75).setScrollFactor(0.25,0.25).setDepth(-1);
        this.add.image(-1000,-1800,"backgroundBackground").setOrigin(0, 0).setScale(0.75).setScrollFactor(0.25,0.25).setDepth(-0.5);
        this.add.image(-1000,-1800,"filtre").setOrigin(0, 0).setScale(0.75).setScrollFactor(0.25,0.25).setAlpha(0.25).setDepth(-0.5);
        this.add.image(-1000,-1800,"background").setOrigin(0, 0).setScale(0.75).setScrollFactor(0.45,0.6).setDepth(-0.20);
        this.add.image(-1000,-1800,"filtre").setOrigin(0, 0).setScale(0.75).setScrollFactor(0.45,0.6).setAlpha(0.1).setDepth(-0.20);
        ...
        this.nuage3Front = this.physics.add.image(1000, 200,"nuage3").setOrigin(0, 0).setScale(0.25).setScrollFactor(0.45,0.6).setDepth(-0.25).setAlpha(0.75);
        this.nuage3Front.body.setVelocityX(60);
        this.nuage3Front2 = this.physics.add.image(2000, 0,"nuage3").setOrigin(0, 0).setScale(0.25).setScrollFactor(0.45,0.6).setDepth(-0.25).setAlpha(0.75);
        this.nuage3Front2.body.setVelocityX(-50);
        this.nuage2Front = this.physics.add.image(3000, 50,"nuage2").setOrigin(0, 0).setScale(0.25).setScrollFactor(0.45,0.6).setDepth(-0.25).setAlpha(0.75);
        this.nuage2Front.body.setVelocityX(-40);
        this.nuage1Front = this.physics.add.image(0, 400,"nuage1").setOrigin(0, 0).setScale(0.25).setScrollFactor(0.45,0.6).setDepth(-0.25).setAlpha(0.75);
        this.nuage1Front.body.setVelocityX(-35);
        

        this.add.image(0, 0, "backLevel05").setOrigin(0, 0).setScale(1).setPipeline('Light2D');
        ...
        this.add.image(0, 0, "frontLevel05").setOrigin(0, 0).setScale(1).setDepth(2).setPipeline('Light2D');
    ...
    //Creation de la map
    createMap() {
        const map = this.make.tilemap({ key: "level05" });
