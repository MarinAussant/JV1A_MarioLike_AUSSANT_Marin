...
class Level04 extends Phaser.Scene {
    ...
    create() {
        ...
        for (let i = -300; i < this.MAP_WIDTH; i += (5263/4)*3){
            this.add.image(i,3500 - this.MAP_HEIGHT,"sky").setOrigin(0, 0).setScale(0.75).setScrollFactor(0.25,0.25).setDepth(-1);
            ...
            this.add.image(i,3500 - this.MAP_HEIGHT,"filtre").setOrigin(0, 0).setScale(0.75).setScrollFactor(0.25,0.25).setAlpha(0.25).setDepth(-0.5);
    ...
    //Creation de la map
    createMap() {
        const map = this.make.tilemap({ key: "level04" });
